...
\newcommand{\PresenceSheet}[6]{
    \begingroup
        ...
        \newbool{biWeekly}
        \ifthenelse{\equal{#6}{TRUE}}{\setbool{biWeekly}{true}}{\setbool{biWeekly}{false}}
        ...
        \ifbool{biWeekly}{\pgfplotstableset{columns/Signature1/.style={string type,column type=S?,column name=\textsc{\Translate{week} 1}}}
                          \pgfplotstableset{columns/Signature2/.style={string type,column type=S?,column name=\textsc{\Translate{week} 2}}}}
                         {\pgfplotstableset{columns/Signature/.style={string type,column type=C?,column name=\textsc{\Translate{signature}}}}}
...
\newenvironmentx{solution}[2][1=, 2=]
{
    ...
    \ifstrempty{#1}{%
        \ifstrempty{#2}{%
            ...
            \noindent{\large\textbf{\Translate{solution-of} \theSolution}}\hfill\texttt{(#2 \translate{score-short})}\\[0.75ex]
        }
    }{%
        \ifstrempty{#2}{%
            \noindent{\large\textbf{\Translate{solution-of} \theSolution}} $\;$[\textit{#1}]\\[0.75ex]
        }{%
            \noindent{\large\textbf{\Translate{solution-of} \theSolution}} $\;$[\textit{#1}]\hfill\texttt{(#2 \translate{score-short})}\\[0.75ex]
        }
    }
}
{\par\vspace{\myskip}}
