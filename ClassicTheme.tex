...
\newcommand{\ExamCoverPage}[2]{%
    ...
    \begingroup
        ...
        \begin{tabular}{rp{0.6\textwidth}}
            ...
            \Translate{ID-number}:  & \underline{\hspace{0.6\textwidth}} \\[5ex]
        \end{tabular}
        ...
        \begin{tabular}{rp{10cm}}
            \Translate{final-mark}:       & \underline{\hspace{9cm}} \\[3ex]
        \end{tabular}
        \par% https://tex.stackexchange.com/a/91539
    \endgroup
    \vfill
...
\newenvironmentx{exercise}[2][1=, 2=]
{
    ...
    \ifthenelse{\isempty{#1}}{%
        \ifthenelse{\isempty{#2}}{%
            ...
            \noindent{\large\textbf{\Translate{exercise} \theExercise}}\hfill\texttt{(#2 pts.)}\\[0.75ex]
        }
    }{%
        \ifthenelse{\isempty{#2}}{%
            \noindent{\large\textbf{\Translate{exercise} \theExercise}} $\;$[\textit{#1}]\\[0.75ex]
        }{%
            \noindent{\large\textbf{\Translate{exercise} \theExercise}} $\;$[\textit{#1}]\hfill\texttt{(#2 pts.)}\\[0.75ex]
        }
    }
}
{\par\vspace{\myskip}}
...
\newenvironment{solution}[1][optional]
{
    ...
    \ifthenelse{\isempty{#1}}{%
        \noindent{\large\textbf{\Translate{exercise} \theSolution}}\\[0.75ex]
    }{%
        \noindent{\large\textbf{\Translate{exercise} \theSolution}} $\;$[\textit{#1}]\\[0.75ex]
    }
}
{\par\vspace{\myskip}}
